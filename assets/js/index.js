    ...
    const categories = [
      { title: "Tủ sách Nhân vật", href: "/nhan-vat-c189", img: "assets/img/banner-bookshelf.jpg", color: "#e2dbff", icon: "bi-journal-bookmark" },
      { title: "Tủ sách Lý luận chính trị", href: "/sach-ly-luan-chinh-tri-c191", img: "assets/img/banner-bookshelf.jpg", color: "#d4ecff", icon: "bi-globe2" },
      { title: "Tủ sách Luật", href: "/tu-sach-luat-c202", img: "assets/img/banner-bookshelf.jpg", color: "#ffe8da", icon: "bi-bookmark-star" },
      { title: "Tủ sách Giáo trình - Tài liệu", href: "/giao-trinh-va-tai-lieu-hoc-tap-c203", img: "assets/img/banner-bookshelf.jpg", color: "#ffd8cf", icon: "bi-building" },
      { title: "Tủ sách Ban chỉ đạo 35", href: "/tu-sach-35-c199", img: "assets/img/banner-bookshelf.jpg", color: "#dcffdf", icon: "bi-file-earmark-text" },
      { title: "Tủ sách Chi Bộ", href: "/tu-sach-chi-bo-c193", img: "assets/img/banner-bookshelf.jpg", color: "#fff0d3", icon: "bi-collection" }
    ];

    const heroSlides = [
      { title: "Slide 1", href: "#", img: "assets/img/banner-slide-1.jpg" },
      { title: "Slide 2", href: "#", img: "assets/img/banner-slide-2.jpg" },
      { title: "Slide 3", href: "#", img: "assets/img/banner-slide-3.jpg" }
    ];
    ...
    const books = [
      ...
      { title: "Thư ký Bác Hồ kể chuyện (Xuất bản lần thứ tư, có chỉnh sửa)", href: "/thu-ky-bac-ho-ke-chuyen-xuat-ban-lan-thu-tu-co-chinh-sua-b14878.html", img: "assets/img/none-cover.svg", price: "53.800₫" },
      { title: "Làng nghề, phố nghề Thăng Long - Hà Nội", href: "/lang-nghe-pho-nghe-thang-long-ha-noi-b14865.html", img: "assets/img/none-cover.svg", price: "53.800₫" },
      ...
      { title: "Phương pháp, kỹ năng, kinh nghiệm chủ trì, tham dự Hội nghị", href: "/phuong-phap-ky-nang-kinh-nghiem-chu-tri-tham-du-hoi-nghi-hoi-thao-khoa-hoc-xuat-ban-lan-thu-hai-b14849.html", img: "assets/img/none-cover.svg", price: "29.900₫" },
      ...
      { title: "Người xưa giữ nước (kể chuyện bảo vệ biên cương, biển đảo)", href: "/nguoi-xua-giu-nuoc-ke-chuyen-bao-ve-bien-cuong-bien-dao-b14846.html", img: "assets/img/none-cover.svg", price: "43.900₫" },
      { title: "Hồ Chí Minh - Vĩ đại một con người (Tái bản)", href: "/ho-chi-minh-vi-dai-mot-con-nguoi-tai-ban-co-chinh-sua-b14842.html", img: "assets/img/none-cover.svg", price: "44.500₫" },
    ...
    const buyMost = [
      ...
      { title: "[Sách nói] Tự hào và tin tưởng dưới lá cờ vẻ vang của Đảng", href: "/sach-noi-tu-hao-va-tin-tuong-duoi-la-co-ve-vang-cua-dang-quyet-tam-xay-dung-mot-nuoc-viet-nam-ngay-cang-giau-manh-van-minh-van-hien-va-anh-hung-b12401.html", img: "assets/img/none-cover.svg", metric: "87 lượt mua" },
    ...
    const viewMost = [
      { title: "Xây dựng và phát triển nền văn hóa Việt Nam tiên tiến", href: "/xay-dung-va-phat-trien-nen-van-hoa-viet-nam-tien-tien-dam-da-ban-sac-dan-toc-b12938.html", img: "assets/img/none-cover.svg", metric: "6368 lượt xem" },
      { title: "[Sách nói] Tự hào và tin tưởng dưới lá cờ vẻ vang của Đảng", href: "/sach-noi-tu-hao-va-tin-tuong-duoi-la-co-ve-vang-cua-dang-quyet-tam-xay-dung-mot-nuoc-viet-nam-ngay-cang-giau-manh-van-minh-van-hien-va-anh-hung-b12401.html", img: "assets/img/none-cover.svg", metric: "4031 lượt xem" },
